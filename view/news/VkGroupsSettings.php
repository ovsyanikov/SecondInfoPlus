...
<html>
    ...
    <section class=" news-section">
        ...
        <div id="DistrictSectionConfirm">
            <h2 class="srch-h2 pers-h2 h2">Добавить группу</h2><input id="NewDistrict" name="Stop_word_inp" type="text" class="srch_panel pers-input" placeholder="Введите новый район"><span id="AddNewDistrictSettings" class="srch_ok ok" title="Подтвердить изменения">N</span>
        </div>
